...
<!--                --><?php //$_GET['navid']=5; ?>
                <?php MemberUIBuilder::CreateOneMemberHorizontalHeaderWidget($_SESSION['memberId'],5) ?>
            </div>
                        ...
                        <div class="ibox-content">
                            ...
                            <p>
                                Many desktop publishing packages and web page editors now use <strong>Lorem Ipsum as
                                    their default model text</strong>, and a search for 'lorem ipsum' will uncover many
                                web
                            </p>
                            <p>
                                ...
                                fitted out with a fur hat and fur boa who sat upright, raising a heavy fur muff that
                                covered the whole of her lower arm towards the viewer. Gregor then turned to look out
                                the window at the dull weather. Drops
                            </p>
                            <p>
                                <i>
                            ...
                            <p>
                                Two driven jocks help fax my big quiz. Quick, Baz, get my woven flax jodhpurs! "Now fax
                                quiz Jack!" my brave ghost pled. Five quacking zephyrs jolt my wax bed. Flummoxed by
                                job, kvetching W. zaps Iraq. Cozy sphinx waves quart jug of bad milk. A very bad quack
                                might jinx zippy fowls. Few quips galvanized the mock jury box. Quick brown dogs jump
                                over the lazy fox. The jay, pig, fox, zebra, and my wolves quack! Blowzy red vixens
                                fight for a quick jump. Joaquin Phoenix was gazed by MTV for luck. A wizard’s job is to
                                vex chumps quickly in fog. Watch "Jeopardy!", Alex Trebek's fun TV quiz game. Woven silk
                            ...
                            <p>
                                ...
                                zephyrs vex bold Jim. Quick zephyrs blow, vexing daft Jim. Sex-charged fop blew my junk
                                TV quiz. How quickly daft jumping zebras vex.
                            </p>
                            <hr>
                            <div class="row">
                                <div class="col-md-6">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <div class="social-feed-box">
                                        <div class="social-avatar">
                                            <a href="article.html" class="pull-left">
                                                <img alt="image" src="Template/img/a5.jpg">
                                            </a>
                                            <div class="media-body">
                                                <a href="article.html#">
                                                    Monica Flex
