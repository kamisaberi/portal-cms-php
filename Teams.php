...
<!--                --><?php //$_GET['navid']=4; ?>
                <?php MemberUIBuilder::CreateOneMemberHorizontalHeaderWidget($_SESSION['memberId'],4) ?>
            </div>
                ...
                <div class="col-lg-4">
                    <div class="ibox">
                        <div class="ibox-title">
                            <span class="label label-primary pull-left">NEW</span>
                            <h5>
                                آلفا-01 تیم طراحی
                            </h5>
                        </div>
                        <div class="ibox-content">
                            <div class="team-members">
                                <a href="teams_board.html#"><img alt="member" class="img-circle" src="Template/img/a1.jpg"></a>
                                <a href="teams_board.html#"><img alt="member" class="img-circle" src="Template/img/a2.jpg"></a>
                                <a href="teams_board.html#"><img alt="member" class="img-circle" src="Template/img/a3.jpg"></a>
                                <a href="teams_board.html#"><img alt="member" class="img-circle" src="Template/img/a5.jpg"></a>
                                <a href="teams_board.html#"><img alt="member" class="img-circle" src="Template/img/a6.jpg"></a>
                            </div>
                            <h4>
                                اطلاعات تیم طراحی
                            ...
                            <p>
                                لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با اس لورم ایپسوم متن ساختگی
                                با
                                تولید سادگی نامفهوم از صنعت چاپ و با اس
                            </p>
                            <div>
                                <span>
                                    وضعیت پروژه جاری:
                    ...
                    <div class="ibox">
                        ...
                        <div class="ibox-content">
                            <div class="team-members">
                                <a href="teams_board.html#"><img alt="member" class="img-circle" src="Template/img/a4.jpg"></a>
                                <a href="teams_board.html#"><img alt="member" class="img-circle" src="Template/img/a5.jpg"></a>
                                <a href="teams_board.html#"><img alt="member" class="img-circle" src="Template/img/a6.jpg"></a>
                                <a href="teams_board.html#"><img alt="member" class="img-circle" src="Template/img/a8.jpg"></a>
                                <a href="teams_board.html#"><img alt="member" class="img-circle" src="Template/img/a7.jpg"></a>
                            </div>
