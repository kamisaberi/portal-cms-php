...
(function (a) {
	...
	a.extend(a.validator, {
	    ...
	    messages: {
	        ...
	        remote: "لطفا مشکل این فیلد را برطرف کنید",
	        email: "لطفا یک آدرس پست الکترونیک معتبر وارد کنید",
	        ...
	        equalTo: "لطفا دوباره مقدار را وارد کنید",
	        maxlength: a.validator.format("لطفا حداکثر {0} کاراکتر را وارد کنید"),
	        minlength: a.validator.format("لطفا حداقل {0} کاراکتر را وارد کنید"),
	        rangelength: a.validator.format("لطفا یک کاراکتر بین {0} و {1} کاراکتر را وارد کنید"),
	        range: a.validator.format("لطفا یک کاراکتر بین {0} و {1} کاراکتر را وارد کنید"),
	        max: a.validator.format("لطفا یک کاراکتر کوچکتر یا برابر با {0} را وارد کنید"),
	        min: a.validator.format("لطفا یک کاراکتر بزرگتر یا برابر با {0} را وارد کنید")
	    },
	    autoCreateRanges: !1,
	    prototype: {
	        init: function () {
