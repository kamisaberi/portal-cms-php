...
if (isset($_GET['id']) && is_numeric($_GET['id'])) {
    $pst = ProductLevelController::FindOneProductLevel($_GET['id']);
    $cm = 'edit';
}
?>
...
<main class="container-fluid fixed-nav-offset">
    <div class="row">
        <form class="form-horizontal" action="OperateProductLevel.php" method="POST">
            <input type="hidden" id="cm" name="cm" value="<?php echo $cm ?>" />
            <?php echo $cm == 'edit' ? "<input type='hidden' id='ProductLevelId' name='ProductLevelId' value='$pst->ProductLevelId' />" : ''; ?>
                        ...
                        <div class="form-horizontal">
                            <div class="form-group no-margin">
                                <div class="col-sm-offset-3 col-sm-9 left-align">
                                    ...
                                    <a class="btn btn-light-orange" href="ProductLevels.php">
