...
if (isset($_GET['id']) && is_numeric($_GET['id'])) {
    $pst = ExamTypeController::FindOneExamType($_GET['id']);
    $cm = 'edit';
}
?>
...
<main class="container-fluid fixed-nav-offset">
    <div class="row">
        <form class="form-horizontal" action="OperateExamType.php" method="POST">
            <input type="hidden" id="cm" name="cm" value="<?php echo $cm ?>" />
            <?php echo $cm == 'edit' ? "<input type='hidden' id='ExamTypeId' name='ExamTypeId' value='$pst->ExamTypeId' />" : ''; ?>
                        ...
                        <div class="form-horizontal">
                            <div class="form-group no-margin">
                                <div class="col-sm-offset-3 col-sm-9 left-align">
                                    ...
                                    <a class="btn btn-light-orange" href="ExamTypes.php">
