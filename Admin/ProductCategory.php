...
if (isset($_GET['id']) && is_numeric($_GET['id'])) {
    $expert = ProductCategoryController::FindOneProductCategory($_GET['id']);
    $cm = 'edit';
...
<main class="container-fluid fixed-nav-offset">
    ...
    <div class="row">
        <form action="OperateProductCategory.php" method="POST" role="form" class="form-horizontal">
            <input type="hidden" id="cm" name="cm" value="<?php echo $cm ?>" />
            <?php echo $cm == 'edit' ? "<input type='hidden' id='ProductCategoryId' name='ProductCategoryId' value='$expert->ProductCategoryId' />" : ''; ?>
                                ...
                                <div class="col-sm-9">
                                    <select name="Parent" id="Parent" class="form-control" >
                                        ...
                                        foreach ($expertparents as $expertparent) {
                                            $selected = "";
                                            if ($cm == 'edit') {
                                                if ($expert->Parent == $expertparent->ProductCategoryId) {
                                                    $selected = "selected";
                                                }
                                            }
                                            //echo $selected . "<br>";
                        ...
                        <div class="form-horizontal">
                            <div class="form-group no-margin">
                                <div class="col-sm-offset-3 col-sm-9 left-align">
                                    <input type="submit" class="btn btn-dark-orange" value="ذخیره" name="InsertProductCategory" />
